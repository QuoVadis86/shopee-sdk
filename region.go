...
var (
	...
	PathGlobalProductGetVideoUploadResult = APIPath("global_product", "get_video_upload_result")
	PathGlobalProductCancelVideoUpload   = APIPath("global_product", "cancel_video_upload")
)
...
var (
	...
	PathLogisticsGetUnbindOrderList       = APIPath("logistics", "get_unbind_order_list")
	PathLogisticsGetDetail                = APIPath("logistics", "get_detail")
	PathLogisticsGetTrackingNumList       = APIPath("logistics", "get_tracking_number_list")
	PathLogisticsGetWaybill               = APIPath("logistics", "get_waybill")
	PathLogisticsGetCourierChannelList    = APIPath("logistics", "get_courier_delivery_channel_list")
	PathLogisticsGetTransitWarehouseList  = APIPath("logistics", "get_transit_warehouse_list")
	PathLogisticsGetCourierDeliveryDetail = APIPath("logistics", "get_courier_delivery_detail")
	PathLogisticsGetCourierDeliveryWaybill = APIPath("logistics", "get_courier_delivery_waybill")
	PathLogisticsGetCourierTrackingList   = APIPath("logistics", "get_courier_delivery_tracking_number_list")
)
...
var (
	...
	PathShopGetMerchantInfo      = APIPath("shop", "get_merchant_info")
	PathShopGetListByMerchant    = APIPath("shop", "get_shop_list_by_merchant")
	PathShopGetMerchantWarehouseLocations = APIPath("shop", "get_merchant_warehouse_location_list")
	PathShopGetMerchantWarehouseList      = APIPath("shop", "get_merchant_warehouse_list")
	PathShopGetWarehouseEligibleShopList  = APIPath("shop", "get_warehouse_eligible_shop_list")
	PathShopGetMerchantPrepaidAccountList = APIPath("shop", "get_merchant_prepaid_account_list")
	PathShopGetPerformance        = APIPath("shop", "get_shop_performance")
	PathShopGetMetricSourceDetail = APIPath("shop", "get_metric_source_detail")
	PathShopGetPenaltyHistory     = APIPath("shop", "get_penalty_point_history")
...
var (
	...
	PathAMSGetCoverList                       = APIPath("ams", "get_cover_list")
	PathAMSEditVideoInfo                      = APIPath("ams", "edit_video_info")
	PathAMSGetVideoList                       = APIPath("ams", "get_video_list")
	PathAMSGetVideoDetail                     = APIPath("ams", "get_video_detail")
	PathAMSDeleteVideo                        = APIPath("ams", "delete_video")
	PathAMSGetOverviewPerformance             = APIPath("ams", "get_overview_performance")
	...
	PathAMSGetVideoDetailProductPerf          = APIPath("ams", "get_video_detail_product_performance")
)
...
var (
	PathPromotionAddDiscount          = APIPath("promotion", "add_discount")
	PathPromotionAddDiscountItem      = APIPath("promotion", "add_discount_item")
	PathPromotionDeleteDiscount       = APIPath("promotion", "delete_discount")
	PathPromotionDeleteDiscountItem   = APIPath("promotion", "delete_discount_item")
	PathPromotionGetDiscount          = APIPath("promotion", "get_discount")
	PathPromotionGetDiscountList      = APIPath("promotion", "get_discount_list")
	PathPromotionUpdateDiscount       = APIPath("promotion", "update_discount")
	PathPromotionUpdateDiscountItem   = APIPath("promotion", "update_discount_item")
	PathPromotionGetSIPDiscounts      = APIPath("promotion", "get_sip_discounts")
	PathPromotionSetSIPDiscount       = APIPath("promotion", "set_sip_discount")
	PathPromotionDeleteSIPDiscount    = APIPath("promotion", "delete_sip_discount")
	PathPromotionAddBundleDeal        = APIPath("promotion", "add_bundle_deal")
	PathPromotionAddBundleDealItem    = APIPath("promotion", "add_bundle_deal_item")
	PathPromotionGetBundleDealList    = APIPath("promotion", "get_bundle_deal_list")
	PathPromotionGetBundleDeal        = APIPath("promotion", "get_bundle_deal")
	PathPromotionGetBundleDealItem    = APIPath("promotion", "get_bundle_deal_item")
	PathPromotionUpdateBundleDeal     = APIPath("promotion", "update_bundle_deal")
	PathPromotionUpdateBundleDealItem = APIPath("promotion", "update_bundle_deal_item")
	PathPromotionDeleteBundleDeal     = APIPath("promotion", "delete_bundle_deal")
	PathPromotionDeleteBundleDealItem = APIPath("promotion", "delete_bundle_deal_item")
	PathPromotionAddAddOnDeal         = APIPath("promotion", "add_add_on_deal")
	PathPromotionAddAddOnDealMainItem = APIPath("promotion", "add_add_on_deal_main_item")
	PathPromotionAddAddOnDealSubItem  = APIPath("promotion", "add_add_on_deal_sub_item")
	PathPromotionDeleteAddOnDeal      = APIPath("promotion", "delete_add_on_deal")
	PathPromotionDeleteAddOnDealMain  = APIPath("promotion", "delete_add_on_deal_main_item")
	PathPromotionDeleteAddOnDealSub   = APIPath("promotion", "delete_add_on_deal_sub_item")
	PathPromotionGetAddOnDealList     = APIPath("promotion", "get_add_on_deal_list")
	PathPromotionGetAddOnDeal         = APIPath("promotion", "get_add_on_deal")
	PathPromotionGetAddOnDealMainItem = APIPath("promotion", "get_add_on_deal_main_item")
	PathPromotionGetAddOnDealSubItem  = APIPath("promotion", "get_add_on_deal_sub_item")
	PathPromotionUpdateAddOnDeal      = APIPath("promotion", "update_add_on_deal")
	PathPromotionUpdateAddOnDealMain  = APIPath("promotion", "update_add_on_deal_main_item")
	PathPromotionUpdateAddOnDealSub   = APIPath("promotion", "update_add_on_deal_sub_item")
	PathPromotionEndAddOnDeal         = APIPath("promotion", "end_add_on_deal")
	PathPromotionAddVoucher           = APIPath("promotion", "add_voucher")
	PathPromotionDeleteVoucher        = APIPath("promotion", "delete_voucher")
	PathPromotionUpdateVoucher        = APIPath("promotion", "update_voucher")
	PathPromotionGetVoucher           = APIPath("promotion", "get_voucher")
	PathPromotionGetVoucherList       = APIPath("promotion", "get_voucher_list")
	PathPromotionGetTimeSlotID        = APIPath("promotion", "get_time_slot_id")
	PathPromotionCreateFlashSale        = APIPath("promotion", "create_shop_flash_sale")
	PathPromotionGetItemCriteria        = APIPath("promotion", "get_item_criteria")
	PathPromotionAddFlashSaleItems      = APIPath("promotion", "add_shop_flash_sale_items")
	PathPromotionGetFlashSaleList       = APIPath("promotion", "get_shop_flash_sale_list")
	PathPromotionGetFlashSale           = APIPath("promotion", "get_shop_flash_sale")
	PathPromotionGetFlashSaleItems      = APIPath("promotion", "get_shop_flash_sale_items")
	PathPromotionUpdateFlashSale        = APIPath("promotion", "update_shop_flash_sale")
	PathPromotionUpdateFlashSaleItems   = APIPath("promotion", "update_shop_flash_sale_items")
	PathPromotionDeleteFlashSale        = APIPath("promotion", "delete_shop_flash_sale")
	PathPromotionDeleteFlashSaleItems   = APIPath("promotion", "delete_shop_flash_sale_items")
	PathPromotionAddFollowPrize       = APIPath("promotion", "add_follow_prize")
	PathPromotionDeleteFollowPrize    = APIPath("promotion", "delete_follow_prize")
	PathPromotionUpdateFollowPrize    = APIPath("promotion", "update_follow_prize")
	PathPromotionGetFollowPrizeDetail = APIPath("promotion", "get_follow_prize_detail")
	PathPromotionGetFollowPrizeList   = APIPath("promotion", "get_follow_prize_list")
	PathPromotionGetTopPicksList      = APIPath("promotion", "get_top_picks_list")
	PathPromotionAddTopPicks          = APIPath("promotion", "add_top_picks")
	PathPromotionUpdateTopPicks       = APIPath("promotion", "update_top_picks")
	PathPromotionDeleteTopPicks       = APIPath("promotion", "delete_top_picks")
	PathPromotionAddShopCategory      = APIPath("promotion", "add_shop_category")
	PathPromotionGetShopCategoryList  = APIPath("promotion", "get_shop_category_list")
	PathPromotionDeleteShopCategory   = APIPath("promotion", "delete_shop_category")
	PathPromotionUpdateShopCategory   = APIPath("promotion", "update_shop_category")
	PathPromotionAddShopCategoryItemList   = APIPath("promotion", "add_item_list")
	PathPromotionGetShopCategoryItemList   = APIPath("promotion", "get_item_list")
	PathPromotionDeleteShopCategoryItemList = APIPath("promotion", "delete_item_list")
)
...
var (
	...
	PathPartnerGetAppPushConfig       = APIPath("partner", "get_app_push_config")
	PathPartnerGetLostPushMessage     = APIPath("partner", "get_lost_push_message")
	PathPartnerGetBoundWHSInfo        = APIPath("partner", "get_bound_whs_info")
)
...
var (
	PathBRQueryShopEnrollmentStatus = APIPath("br", "query_br_shop_enrollment_status")
	PathBRQueryShopInvoiceError     = APIPath("br", "query_br_shop_invoice_error")
	PathBRQueryShopBlockStatus      = APIPath("br", "query_br_shop_block_status")
	PathBRQuerySKUBlockStatus       = APIPath("br", "query_br_sku_block_status")
)
...
var (
	PathWHSGetCurrentInventory = APIPath("warehouse", "get_current_inventory")
	PathWHSGetExpiryReport     = APIPath("warehouse", "get_expiry_report")
	PathWHSGetStockAging       = APIPath("warehouse", "get_stock_aging")
	PathWHSGetStockMovement    = APIPath("warehouse", "get_stock_movement")
)
...
var (
	PathLiveCreateSession         = APIPath("media", "create_session")
	PathLiveUpdateSession         = APIPath("media", "update_session")
	PathLiveGetSessionDetail      = APIPath("media", "get_session_detail")
	PathLiveAddItemList           = APIPath("media", "add_item_list")
	PathLiveDeleteItemList        = APIPath("media", "delete_item_list")
	PathLiveUpdateItemList        = APIPath("media", "update_item_list")
	PathLiveGetItemCount          = APIPath("media", "get_item_count")
	PathLiveGetItemList           = APIPath("media", "get_item_list")
	PathLiveUpdateShowItem        = APIPath("media", "update_show_item")
	PathLiveDeleteShowItem        = APIPath("media", "delete_show_item")
	PathLiveGetShowItem           = APIPath("media", "get_show_item")
	PathLiveGetLikeItemList       = APIPath("media", "get_like_item_list")
	PathLiveGetRecentItemList     = APIPath("media", "get_recent_item_list")
	PathLiveGetItemSetList        = APIPath("media", "get_item_set_list")
	PathLiveGetItemSetItemList    = APIPath("media", "get_item_set_item_list")
	PathLiveGetSessionMetric      = APIPath("media", "get_session_metric")
	PathLiveGetSessionItemMetric  = APIPath("media", "get_session_item_metric")
	PathLiveGetLatestCommentList  = APIPath("media", "get_latest_comment_list")
)
