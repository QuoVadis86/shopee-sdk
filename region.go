...
var (
	...
	PathPartnerGetAccessToken         = APIPath("public", "get_access_token")
	PathPartnerRefreshAccessToken     = APIPath("public", "refresh_access_token")
...
var (
	...
	PathAdsListGmsUserDeletedItem                     = APIPath("ads", "list_gms_user_deleted_item")
		PathAmsTerminateTargetedCampaign                  = APIPath("ams", "terminate_targeted_campaign")
		PathBundleDealEndBundleDeal                       = APIPath("bundle_deal", "end_bundle_deal")
		PathDiscountEndDiscount                           = APIPath("discount", "end_discount")
		PathFirstMileBindCourierDeliveryFirstMileTrackingNumber = APIPath("first_mile", "bind_courier_delivery_first_mile_tracking_number")
		PathFirstMileBindFirstMileTrackingNumber          = APIPath("first_mile", "bind_first_mile_tracking_number")
		PathFirstMileGenerateAndBindFirstMileTrackingNumber = APIPath("first_mile", "generate_and_bind_first_mile_tracking_number")
		PathFirstMileGenerateFirstMileTrackingNumber      = APIPath("first_mile", "generate_first_mile_tracking_number")
		PathFirstMileGetChannelList                       = APIPath("first_mile", "get_channel_list")
		PathFirstMileUnbindFirstMileTrackingNumber        = APIPath("first_mile", "unbind_first_mile_tracking_number")
		PathFirstMileUnbindFirstMileTrackingNumberAll     = APIPath("first_mile", "unbind_first_mile_tracking_number_all")
		PathFollowPrizeEndFollowPrize                     = APIPath("follow_prize", "end_follow_prize")
		PathGlobalProductCategoryRecommend                = APIPath("global_product", "category_recommend")
		PathGlobalProductInitTierVariation                = APIPath("global_product", "init_tier_variation")
		PathGlobalProductSupportSizeChart                 = APIPath("global_product", "support_size_chart")
		PathLivestreamAddItemList                         = APIPath("livestream", "add_item_list")
		PathLivestreamApplyItemSet                        = APIPath("livestream", "apply_item_set")
		PathLivestreamBanUserComment                      = APIPath("livestream", "ban_user_comment")
		PathLivestreamDeleteItemList                      = APIPath("livestream", "delete_item_list")
		PathLivestreamEndSession                          = APIPath("livestream", "end_session")
		PathLivestreamGetItemList                         = APIPath("livestream", "get_item_list")
		PathLivestreamPostComment                         = APIPath("livestream", "post_comment")
		PathLivestreamStartSession                        = APIPath("livestream", "start_session")
		PathLivestreamUnbanUserComment                    = APIPath("livestream", "unban_user_comment")
		PathLivestreamUploadImage                         = APIPath("livestream", "upload_image")
		PathLogisticsDownloadBookingShippingDocument      = APIPath("logistics", "download_booking_shipping_document")
		PathLogisticsDownloadShippingDocument             = APIPath("logistics", "download_shipping_document")
		PathLogisticsDownloadShippingDocumentJob          = APIPath("logistics", "download_shipping_document_job")
		PathLogisticsDownloadToLabel                      = APIPath("logistics", "download_to_label")
		PathLogisticsUploadServiceablePolygon             = APIPath("logistics", "upload_serviceable_polygon")
		PathMediaCancelVideoUpload                        = APIPath("media", "cancel_video_upload")
		PathMediaCompleteVideoUpload                      = APIPath("media", "complete_video_upload")
		PathMediaGetVideoUploadResult                     = APIPath("media", "get_video_upload_result")
		PathMediaInitVideoUpload                          = APIPath("media", "init_video_upload")
		PathMediaUploadImage                              = APIPath("media", "upload_image")
		PathMediaUploadVideoPart                          = APIPath("media", "upload_video_part")
		PathMediaSpaceCompleteVideoUpload                 = APIPath("media_space", "complete_video_upload")
		PathMediaSpaceInitVideoUpload                     = APIPath("media_space", "init_video_upload")
		PathMediaSpaceUploadImage                         = APIPath("media_space", "upload_image")
		PathMediaSpaceUploadVideoPart                     = APIPath("media_space", "upload_video_part")
		PathOrderDownloadFbsInvoices                      = APIPath("order", "download_fbs_invoices")
		PathOrderDownloadInvoiceDoc                       = APIPath("order", "download_invoice_doc")
		PathOrderGenerateFbsInvoices                      = APIPath("order", "generate_fbs_invoices")
		PathOrderHandleBuyerCancellation                  = APIPath("order", "handle_buyer_cancellation")
		PathOrderHandlePrescriptionCheck                  = APIPath("order", "handle_prescription_check")
		PathOrderUploadInvoiceDoc                         = APIPath("order", "upload_invoice_doc")
		PathPaymentGenerateIncomeReport                   = APIPath("payment", "generate_income_report")
		PathPaymentGenerateIncomeStatement                = APIPath("payment", "generate_income_statement")
		PathPrincipalGetClipVideoPerformance              = APIPath("principal", "get_clip_video_performance")
		PathPrincipalGetContentAffiliatePerformance       = APIPath("principal", "get_content_affiliate_performance")
		PathPrincipalGetPrincipalAffiliatePerformance     = APIPath("principal", "get_principal_affiliate_performance")
		PathPrincipalGetPrincipalLivestreamPerformance    = APIPath("principal", "get_principal_livestream_performance")
		PathPrincipalGetPrincipalSalesPerformanceDetail   = APIPath("principal", "get_principal_sales_performance_detail")
		PathPrincipalGetPrincipalVideoPerformance         = APIPath("principal", "get_principal_video_performance")
		PathPrincipalGetSessionLivestreamPerformance      = APIPath("principal", "get_session_livestream_performance")
		PathPrincipalGetShopAffiliatePerformance          = APIPath("principal", "get_shop_affiliate_performance")
		PathPrincipalGetShopLivestreamPerformance         = APIPath("principal", "get_shop_livestream_performance")
		PathPrincipalGetShopSalesPerformanceDetail        = APIPath("principal", "get_shop_sales_performance_detail")
		PathPrincipalGetShopVideoPerformance              = APIPath("principal", "get_shop_video_performance")
		PathProductBatchAddItem                           = APIPath("product", "batch_add_item")
		PathProductBatchPublishItemToOutletShop           = APIPath("product", "batch_publish_item_to_outlet_shop")
		PathProductBatchUpdateOutletPrice                 = APIPath("product", "batch_update_outlet_price")
		PathProductBatchUpdateOutletStock                 = APIPath("product", "batch_update_outlet_stock")
		PathProductCategoryRecommend                      = APIPath("product", "category_recommend")
		PathProductGenerateKitImage                       = APIPath("product", "generate_kit_image")
		PathProductInitTierVariation                      = APIPath("product", "init_tier_variation")
		PathProductRegisterBrand                          = APIPath("product", "register_brand")
		PathProductReplyComment                           = APIPath("product", "reply_comment")
		PathProductSearchItem                             = APIPath("product", "search_item")
		PathPublicGetAccessToken                          = APIPath("public", "get_access_token")
		PathPublicRefreshAccessToken                      = APIPath("public", "refresh_access_token")
		PathPushConfirmConsumedLostPushMessage            = APIPath("push", "confirm_consumed_lost_push_message")
		PathReturnsAcceptOffer                            = APIPath("returns", "accept_offer")
		PathReturnsConfirm                                = APIPath("returns", "confirm")
		PathReturnsConvertImage                           = APIPath("returns", "convert_image")
		PathReturnsDispute                                = APIPath("returns", "dispute")
		PathReturnsOffer                                  = APIPath("returns", "offer")
		PathReturnsUploadProof                            = APIPath("returns", "upload_proof")
		PathReturnsUploadShippingProof                    = APIPath("returns", "upload_shipping_proof")
		PathShopCategoryGetItemList                       = APIPath("shop_category", "get_item_list")
		PathVideoGetProdcutPerformanceList                = APIPath("video", "get_prodcut_performance_list")
		PathVideoPostVideo                                = APIPath("video", "post_video")
		PathVoucherEndVoucher                             = APIPath("voucher", "end_voucher")
	PathAccountHealthGetShopPerformance          = APIPath("account_health", "get_shop_performance")
	PathAdsGetTotalBalance                        = APIPath("ads", "get_total_balance")
	PathProductGetBatchTaskResult                 = APIPath("product", "get_batch_task_result")
)
